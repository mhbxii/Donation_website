...
namespace dotnet9.Services
{
    public class ArticleMgmtService : IArticleMgmtService
    {
        ...
        public ArticleMgmtService(IArticleRepository articleRepo, IImageRepository ImageRepo, IImageUploadService imageUploadService, AppDbContext appDbContext, IConfiguration configuration)
        {
